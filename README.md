...
| `help.js` | Модальне вікно довідки, вибір ролі, історія змін |
| `help-child.js` | Дитячі довідки, довідник зірок і пояснення серії |
| `help-parent.js` | Батьківські довідки |
| `help-shared.js` | Спільний розділювач і таблиця досягнень |
...
**В `help-child.js` та `help-parent.js`:**
```js
...
- ✅ `G('зробив', 'зробила')` — у `help-child.js` та `help-parent.js`, де `G` вже визначено
