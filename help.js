...
const HELP_CHILD = {
    ...
    tasksSection: `
        <p>Тут зібрано все що ти зробила або плануєш зробити для отримання зірок ✨</p>
        ${HR}
        <p>🎯 <b>Активні завдання</b><br>
        Це завдання, які тобі дали батьки. Виконай — і отримаєш зірки.<br>
        ✔️ <b>Виконала</b> — натисни коли все зробила, батьки перевірять<br>
        ...
        ${HR}
        <p>✖️ <b>Якщо ти відмовилась</b><br>
        Можеш обрати готову причину або написати свою.<br>
        Завдання залишиться у списку, батьки побачать твою відповідь.<br>
        Якщо передумала — натисни <b>↩️ Все ж виконати</b></p>
        ${HR}
        <p>📨 <b>Мої запити на перевірці</b><br>
        Це запити які ти надіслала через розділ <b>➕ Додати</b>.<br>
        Чекай поки батьки підтвердять або відхилять.<br>
        🗑️ <b>Скасувати запит</b> — якщо передумала або помилилась</p>
        ${HR}
        <p>📜 <b>Завершено</b><br>
        Тут видно що було підтверджено ✅ або відхилено ❌ за останні 7 днів.<br>
...
<p style="font-size:11px;color:var(--text-muted);margin-top:4px;">❗ — повторюється після кожного виконання</p>
    ...
    settingsSection: `
        ...
        Три компактні кнопки зверху:<br>
        📱 <b>Про</b> — опис програми та можливостей<br>
        📝 <b>Зміни</b> — історія оновлень версій<br>
        🗂️ <b>Версії</b> — таблиця версій усіх файлів<br>
        Нижче — статистика твоїх записів, досягнень, тем, завдань та повідомлень.</p>
        ${HR}
        ...
        🔴 Червона крапка — є нові сповіщення. Натиск на сповіщення про нову версію відкриває історію змін.</p>
        ${HR}
    ...
    about: `
        ...
        За оцінки, навчання, читання, домашні справи, активність, гігієну.<br>
        📖 Читачка має <b>6 рівнів</b> — рахує прочитані сторінки.</p>
        ${HR}
        ...
        ${HR}
        <p>🎯 <b>Цілі</b><br>
        Постав собі ціль — і йди до неї крок за кроком!<br>
        Бачитимеш скільки залишилось до мети у вкладці «Графіки».</p>
        ${HR}
        <p>📋 <b>Завдання</b><br>
        Батьки можуть створювати для тебе завдання з нагородою у зірках.<br>
        Виконала — натисни «Готово» і чекай на підтвердження.<br>
        ...
        ${HR}
        <p>🔔 <b>Сповіщення</b><br>
        Дзвіночок у хедері покаже нові події: відповіді батьків,<br>
        нові досягнення, нагадування і нові версії програми.<br>
        Тап на сповіщенні про нову версію — відкриває історію змін.</p>
...
const HELP_PARENT = {
    ...
    tasksSection: `
        ...
        <p>Тут ви обробляєте запити від дитини та створюєте власні завдання з дедлайнами.</p>
        ${HR}
        <p>➕ <b>Створити нове завдання</b><br>
        🌟 <b>Бонус</b> — обираєте з готового списку (як у блоці Додати)<br>
        ✨ <b>Особливе нарахування</b> — довільний опис та кількість зірок<br>
        ⏰ <b>Дедлайн</b> (опційно) — вкажіть дату і час, дитина бачитиме таймер<br>
        🎁 <b>Винагорода за виконання</b> — додаткові зірки (дефолт 1⭐), або позначте "Без додаткової винагороди". При підтвердженні в Історії з'явиться окремий запис <b>"✅ Виконане завдання"</b> для статистики.<br>
        Після створення завдання з'являється у дитини зі статусом <b>🎯 Активне</b></p>
        ${HR}
        <p>📨 <b>Запити дитини на підтвердження</b><br>
        Сюди потрапляють усі записи, які дитина надіслала через розділ <b>➕ Додати</b>.<br>
        ✅ <b>Підтвердити</b> — зірки нараховуються, запис йде в Історію як звичайне нарахування.<br>
        ❌ <b>Відхилити</b> — оберіть готову причину або напишіть свою. Дитина побачить коментар.</p>
        ${HR}
        <p>📋 <b>Активні завдання</b><br>
        Завдання, які ви створили, але дитина ще не виконала.<br>
        Якщо дитина відмовилась — побачите її коментар на жовтій рамці.<br>
        Якщо виконала — статус зміниться на <b>✔️ На перевірці</b>, з'явиться кнопка <b>Підтвердити</b>.<br>
        ✏️ <b>Редагувати</b> — змінити дедлайн або винагороду активного завдання (дитина побачить сповіщення про зміни).</p>
        ${HR}
        <p>📜 <b>Завершені</b><br>
        Підтверджені ✅ та відхилені ❌ завдання зберігаються 7 днів, потім автоматично видаляються.<br>
        🗑️ Можна видалити достроково кнопкою</p>
        ${HR}
        <p>🔍 <b>Фільтри</b> — за статусом і за типом (запити / завдання)<br>
        🔔 Сповіщення з'являються коли є що зробити: новий запит, виконане завдання, відмова дитини</p>
    `,
...
<p style="font-size:11px;color:var(--text-muted);margin-top:4px;">❗ — досягнення повторюються після кожного виконання</p>
    ...
    settingsSection: `
        ...
        <p>Розділ організовано як чотири блоки-акордеони. Натиск на заголовок розгортає або згортає блок. Кілька блоків можуть бути відкриті одночасно.</p>
        ${HR}
        <p>🎨 <b>Теми оформлення</b><br>
        ...
        ↩️ <b>Повернення</b> — батьки можуть повернути куплену тему<br>
        ...
        ${HR}
        <p>💾 <b>Резервні копії</b><br>
        📤 <b>Експорт</b> — зберігає всі дані у файл JSON. <b>Рекомендується щотижня!</b><br>
        📥 <b>Імпорт</b> — <b>⚠️ повністю замінює всі поточні дані</b><br>
        🗑️ <b>Скидання всіх даних</b> — <b>⚠️ дія незворотна, зробіть експорт перед скиданням</b></p>
        ${HR}
        <p>🔧 <b>Корекція даних</b> (видно лише в батьківському режимі)<br>
        💰 <b>Корекція балансу</b> — для виправлення помилок, з записом у Історії<br>
        🛠️ <b>Додати запис вручну</b> — відновлення втрачених записів, з вибором досягнення або власним<br>
        ⭐ <b>Курси конвертації</b> — 🎮 хвилин за 1⭐ / 💵 гривень за 1⭐, одразу застосовуються у Витратах<br>
        🔐 <b>PIN-код</b> — захищає батьківський режим. При невірному PIN — автоматичний вхід як Дитина. <b>⚠️ Якщо забудете — доступ буде закрито</b></p>
        ${HR}
        <p>ℹ️ <b>Про програму</b><br>
        Зверху — три компактні кнопки:<br>
        📱 <b>Про</b> — опис програми та можливостей<br>
        📝 <b>Зміни</b> — історія оновлень версій (бейдж зникає після перегляду)<br>
        🗂️ <b>Версії</b> — таблиця версій всіх файлів програми<br>
        Нижче — автоматична статистика: записи в історії, баланс, досягнення, канікули, завдання та запити (за статусами), повідомлення, теми, активність дитини (час прямого входу та входу після невірного PIN), стан резервної копії, розмір даних.</p>
        ${HR}
        <p>🔔 <b>Сповіщення</b> (дзвіночок у хедері)<br>
        Нові сповіщення для батьків:<br>
        💬 Нове повідомлення від дитини / ✏️ Новий або змінений коментар дитини<br>
        🏆 Нові досягнення / 📝 Нова версія програми (тап відкриває історію змін поверх вкладки)<br>
        ...
        Червона крапка дублюється: на дзвіночку, на табі та на акордеоні відповідного блоку</p>
    `,
    ...
    about: `
        ...
        потрійний за діагностувальні роботи (математична діагностувальна — ×6).
        Бонуси за домашні справи, читання, гігієну та активність.
        ...
        самостійно. Курси конвертації (хвилин і гривень за зірку) налаштовуються батьками.</p>
        ${HR}
        <p>🏆 <b>17 досягнень</b><br>
        Кожне досягнення — 3 рівні (бронза/срібло/золото) з автоматичними бонусними зірками.<br>
        📊 Оцінки: Відмінник / Зіркова / Тверда десятка<br>
        📚 Навчання: Старанна / Мегамозок / Книголюб<br>
        📖 Читачка — <b>6 рівнів</b>, рахує прочитані сторінки (бронза → сапфір)<br>
        🏠 Вдома: Помічниця / Господиня / Активна<br>
        🧼 Гігієна (повторювані серії): Чистюля / Красуня<br>
        🌟 Особливі: Fire Streak / Ощадливий / Транжира / Швидкий старт / Цілеспрямована</p>
        ${HR}
        <p>🎯 <b>Цілі</b><br>
        Дитина (або батьки) встановлює ціль у зірках на період. Прогрес видно у вкладці
        «Графіки», а досягнення «Цілеспрямована» нараховується за виконані цілі.</p>
        ${HR}
        <p>📋 <b>Завдання та запити</b><br>
        Батьки створюють завдання з нагородою — дитина виконує і подає на підтвердження.
        Дитина може надсилати власні запити (наприклад, додаткову роботу по дому),
        батьки підтверджують або відхиляють. Всі статуси та зміни — у сповіщеннях.</p>
        ${HR}
        ...
        динаміка тижня, нові досягнення, нові завдання/запити та зміни їх статусу,
        нагадування про резервну копію, нова версія програми.
        Тап на сповіщенні про нову версію відкриває історію змін.
        Окремий потік для кожного профілю.</p>
        ${HR}
        ...
        зірки під час канікул — серії все одно зростають.
        Серії «Чистюля» та «Красуня» не заморожуються — гігієна щодня.</p>
        ${HR}
        <p>⚙️ <b>Налаштування та керування даними</b><br>
        Резервні копії JSON, корекція балансу з записом у Історії, ручне додавання записів,
        курси конвертації, PIN-код для батьківського режиму. Інформація про дані з усією
        статистикою та таблиця версій усіх файлів програми.</p>
        ${HR}
        <p>☁️ <b>Технічно</b><br>
