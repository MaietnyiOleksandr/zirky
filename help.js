...
const HELP_CHILD = {
    ...
    settingsSection: `
        ...
        🔄✅❌ — відповідь батьків з'явиться у картці з датою<br>
        До будь-якого повідомлення можна додати свій коментар</p>
        ${HR}
        ...
        Тут з'являються: нові відповіді батьків, зміни статусу, нові досягнення,<br>
        нагадування про ризик серії, ціль близько та інше.<br>
...
const HELP_PARENT = {
    ...
    settingsSection: `
        ...
        ${HR}
        <p>💬 <b>Зворотній зв'язок</b><br>
        Дитина надсилає побажання та запитання.<br>
        Нові повідомлення — червоний бейдж на вкладці ⚙️<br>
        <b>Як опрацьовувати:</b> натисніть на статус → оберіть новий зі списку.<br>
        Статуси: ⏳ Нове / 🔄 В опрацюванні / ✅ Виконано / ❌ Відхилено<br>
        Залиште коментар — дитина одразу побачить відповідь з датою.<br>
        Коментар можна редагувати ✏️ або видалити 🗑️<br>
        Повідомлення можна видалити — з підтвердженням</p>
        ${HR}
        <p>🎨 <b>Теми оформлення</b><br>
