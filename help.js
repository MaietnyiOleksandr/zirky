...
const HELP_CHILD = {
    ...
    settingsSection: `
        ...
        🔐 Зміна PIN / 💰 Корекція балансу / ⭐ Курси конвертації<br>
        📚 Предмети та гуртки (в табі Розклад)</p>
    `,
...
const HELP_PARENT = {
    ...
    scheduleSection: `
        ...
        ${HR}
        <p>◀ ▶ — перегортай дні тижня<br>
        Між стрілками — день, дата та номер тижня (якщо двотижневий розклад)</p>
        ${HR}
        <p>🧑‍🏫 <b>Вчителі</b> — редагуй ПІБ вчителів по предметах та класного керівника.<br>
        Редагувати можуть і батьки, і дитина.<br>
        🕐 <b>Дзвінки</b> — встанови час початку і кінця кожного уроку</p>
        ${HR}
        <p><b>Тільки для батьків:</b><br>
        ✏️ <b>Редагувати розклад</b> — вибери день, додай урок зі списку предметів<br>
        Якщо розклад двотижневий — перемикай між тижнем А та Б<br>
        🎭 <b>Гуртки</b> — додай гуртки з часом початку/кінця<br>
        📚 <b>Предмети та гуртки</b> — керуй списком предметів (назва, іконка, подвійні зірки)<br>
